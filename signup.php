		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="index.php" id="our-location" class="btn-success">Login</a></li>
				</ul>
...
?>
			...
			<section class="slider text-center" id="slider">
				<div class="modal-dialog ">
					...
					<div class="right-box">
						<span class="signinwith" style="color: #fff;">Sign in With <br> Social Networks</span>

						<button class="social google"><a href="<?php echo $google_client->createAuthUrl() ?>">Log in with gmail</button>
					</div>				
					</div>						
				</div>
			</div>
