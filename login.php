		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="signup.php" id="our-location" class="btn-success">Signup</a></li>
				</ul>
				...
				<div class="modal-dialog ">
					...
					<div class="modal-body" >
						...
						<form method="POST" action="validation.php" onsubmit="return validation()">
							...
							<div class="register">
								<h2>Don't have an account?&nbsp<span id="create-account"><a href="signup.php" style="color: red;">Create</span></a> </h2>
							</div>
